import"./supabase-CGTu0p87.js";/* empty css              */import{i as r}from"./auth-Dtda0RQ8.js";import{b as c,c as o,a as i,d as n}from"./data-CMEYWzjb.js";import"https://esm.sh/@supabase/supabase-js@2";const l=document.body.dataset.current;document.querySelectorAll("[data-nav]").forEach(t=>{t.dataset.nav===l&&t.classList.add("active")});r();(async()=>{try{const t=await c(),e=document.querySelectorAll(".live-stat strong");e[0]&&(e[0].textContent=t.jobs),e[1]&&(e[1].textContent=t.companies),e[2]&&(e[2].textContent=t.articles)}catch(t){console.error("Stats load error:",t)}try{const{jobs:t}=await o({limit:3}),e=document.querySelector(".job-grid-3");e&&t.length>0&&(e.innerHTML=t.map(a=>`

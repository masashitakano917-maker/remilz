import"../supabase-CGTu0p87.js";/* empty css               */import{r as d,s as i}from"../auth-fCQxssmt.js";import{a as l,b as c}from"../admin-data-Bahd-xFg.js";import"https://esm.sh/@supabase/supabase-js@2";const s=document.body.dataset.adminCurrent;document.querySelectorAll("[data-admin]").forEach(t=>{t.dataset.admin===s&&t.classList.add("active")});(async()=>await d()&&r())();async function r(){const t=document.querySelector(".admin-table tbody");try{const a=await l();t.innerHTML=a.map(e=>`
        <tr>
          <td>${e.name}</td>
          <td>${e.category||"-"}</td>

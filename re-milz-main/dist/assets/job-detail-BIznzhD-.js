import"./supabase-CGTu0p87.js";/* empty css              */import{i as a}from"./auth-fCQxssmt.js";import{d as o}from"./data-Dlum6TGs.js";import"https://esm.sh/@supabase/supabase-js@2";const r=document.body.dataset.current;document.querySelectorAll("[data-nav]").forEach(t=>{t.dataset.nav===r&&t.classList.add("active")});a();const s=new URLSearchParams(window.location.search),n=s.get("id");n&&(async()=>{try{const t=await o(n);if(!t)return;document.querySelector(".page-title").textContent=t.title,document.querySelector(".page-lead").textContent=t.description||"",document.querySelector(".hero-side-card p").textContent=(t.tags||[]).join(" / ");const i=document.querySelector(".detail-main");i.innerHTML=`
          <h2>募集概要</h2>
          <p>${t.description||""}</p>

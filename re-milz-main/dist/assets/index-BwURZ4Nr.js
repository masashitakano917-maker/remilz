import{i as r}from"./auth-C3nl4jWx.js";/* empty css              */import{b as s,c,a as o}from"./data-Dn2T_C1I.js";import"https://esm.sh/@supabase/supabase-js@2";const l=document.body.dataset.current;document.querySelectorAll("[data-nav]").forEach(t=>{t.dataset.nav===l&&t.classList.add("active")});r();(async()=>{try{const t=await s(),e=document.querySelectorAll(".live-stat strong");e[0]&&(e[0].textContent=t.jobs),e[1]&&(e[1].textContent=t.companies),e[2]&&(e[2].textContent=t.articles)}catch(t){console.error("Stats load error:",t)}try{const{jobs:t}=await c({limit:3}),e=document.querySelector(".job-grid");e&&t.length>0&&(e.innerHTML=t.map(a=>`

import{i as l}from"./auth-C3nl4jWx.js";/* empty css              */import{c as d}from"./data-Dn2T_C1I.js";import"https://esm.sh/@supabase/supabase-js@2";const o=document.body.dataset.current;document.querySelectorAll("[data-nav]").forEach(a=>{a.dataset.nav===o&&a.classList.add("active")});l();const n=document.querySelector(".list-stack"),s=document.querySelector(".search-bar input"),p=document.querySelector(".search-bar button");async function r(a=""){const i=[];document.querySelectorAll(".filter-box input:checked").forEach(e=>{i.push(e.parentElement.textContent.trim())}),n.innerHTML='<p style="padding:24px;color:var(--muted)">読み込み中...</p>';try{const{jobs:e,total:u}=await d({search:a,tags:i});if(e.length===0){n.innerHTML='<p style="padding:24px;color:var(--muted)">該当する求人が見つかりませんでした。</p>';return}n.innerHTML=e.map(t=>`
